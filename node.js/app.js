...
app.configure(function(){
 ...
 app.use(express.cookieParser()); 
    app.use(express.session({store: mongooseSessionStore, secret:config.authentication.session_secret, cookie: {maxAge: new Date(Date.now() + (config.authentication.duration ? config.authentication.duration : 3600*24*1000)), path: config.hosting.basepath }}));
